...
```text
dili1324/weather-agent-tempoisno010x2
```
...
```text
POST https://api.github.com/repos/dili1324/weather-agent-tempoisno010x2/actions/workflows/weather-agent.yml/dispatches
```
...
Create a fine-grained personal access token for the repository `dili1324/weather-agent-tempoisno010x2`.
...
curl -L \
  ...
  https://api.github.com/repos/dili1324/weather-agent-tempoisno010x2/actions/workflows/weather-agent.yml/dispatches \
  -d '{"ref":"main"}'
```
...
```text
URL: https://api.github.com/repos/dili1324/weather-agent-tempoisno010x2/actions/workflows/weather-agent.yml/dispatches
Method: POST
...
- Use a fine-grained PAT scoped only to `dili1324/weather-agent-tempoisno010x2`.
